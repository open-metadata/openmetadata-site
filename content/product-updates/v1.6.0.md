...
false. Visualize table connections through primary and foreign key constraints


false. Navigate between data assets to discover relationships


false. Modify connections using the built-in UI editor
...
false. Document detailed metric calculations and descriptions


false. Record calculation formulas and implementation code (Python, Java, SQL, LaTeX)


false. Visualize metric lineage from source data to insights
...
false. **OpenAPI**: Extract rich metadata from OpenAPI specifications, including endpoints and schemas.


false. **Sigma**: Bringing in your BI dashboard information.


false. **Exasol**: Gain insights into your Exasol database, now supported thanks to Nicola Coretti’s OSS contribution!
...
**Matillion, Azure Data Factory, Stitch, PowerBI Server** and **Vertex AI!**
