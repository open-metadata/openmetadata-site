                ...
                <div className="max-w-[1440px] mx-auto py-28 md:py-20 px-4 md:px-10 xl:px-16">
                    <div className="grid gap-16 lg:grid-cols-2 xl:grid-cols-3">
                        <div className="xl:col-span-2">
                            <p className="uppercase text-[#7147E8] tracking-[0.04em] text-lg font-medium text-center lg:text-left md:font-bold">on demand webinar video</p>
                            <h1 className="text-[#292929] tracking-[-0.02em] font-medium my-4 text-[44px] leading-[52px] text-center lg:text-left md:text-6xl xl:max-w-[80%]">Community Spotlight—OpenMetadata @ Carrefour Brasil</h1>
                            <div className="flex gap-3 justify-center my-5 sm:gap-4 lg:justify-start">
                                <Image src='/assets/omd-logo.svg' alt="OMD Logo" width={147} height={58} />
                                <Image src='/assets/landingPage/cross.svg' alt="Cross" width={45} height={45} />
                                ...
                                {SPEAKERS.map(item => (
                                    <div key={item.name} className="flex items-center gap-3">
                                        ...
                                        <div className="tracking-[-0.02em] font-medium">
                                            <div className="text-[#0D0337] sm:text-[20px]">{item.name}</div>
                                            <div className="text-[#757575] sm:text-lg">{item.designation}</div>
                                        </div>
                                    </div>
                                ))}
                            </div>
