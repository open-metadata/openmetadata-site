...
const CarrefourCaseStudyPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Carrefour Brazil: Data Governance Success with OpenMetadata</title>
            </Head>
            <div>
                ...
                <div className="mt-20 md:mt-24 lg:mt-32">
                    <CustomerHeader customerHeader={CARREFOUR_CUSTOMER_HEADER} highlights={CARREFOUR_CUSTOMER_HIGHLIGHTS} />
