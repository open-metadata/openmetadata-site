      ...
      <div className="mt-20 md:mt-24 lg:mt-32">
        <div className="case-study-page">
          <div className="max-w-[1440px] mx-auto py-28 md:py-20 px-5 md:px-10 xl:px-20">
            ...
            <div className="text-black mt-4 md:text-lg md:max-w-[72%]">
              ...
              community is leveraging the OpenMetadata.
            </div>
                ...
                >
                  ...
                  <div
                    className={`mt-4 font-medium text-black tracking-[-0.02em] px-2 text-2xl ${
                      index > 1 ? "lg:text-2xl" : "lg:text-3xl"
                    }`}
                  >
                    {customer.title}
                  </div>
          ...
          <div className="flex items-center gap-2 w-full lg:justify-between">
            <div className="hidden gap-3 lg:flex">
              {INDUSTRY_LIST.map((industry) => (
                <button
                  key={industry}
                  className={`xl:text-lg tracking-[-0.02em] px-4 py-2 rounded-[3px] cursor-pointer ${
                    activeIndustry === industry
                      ? "bg-[#7147E8] text-white"
                      : "text-[#767676] bg-[#EEEEEE]"
                  }`}
            ...
            <div className="relative lg:hidden">
              ...
              >
                <Image
                  src={`/assets/customer-gallery/filter.svg`}
                  alt="Filter icon"
                  width={20}
                  height={20}
                />
              ...
              <div
                className={`py-2 absolute top-10 left-0 w-[150px] flex flex-col gap-1 items-start bg-white shadow-lg ${
              ...
              >
                {INDUSTRY_LIST.map((industry) => (
                  <button
                    key={industry}
                    className={`tracking-[-0.02em] px-4 py-1 rounded-[3px] cursor-pointer ${
                      activeIndustry === industry
                        ? "text-[#7147E8]"
                        : "text-[#767676]"
                    }`}
        ...
        <div className="bg-[#DCECF8]">
          <div className="max-w-[1440px] mx-auto py-8 md:py-16 px-5 md:px-10 xl:px-20">
            <div className="text-black text-2xl md:text-4xl font-medium tracking-[-0.02em] md:max-w-[70%]">
