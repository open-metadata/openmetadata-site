const IMAGE_ROUTE = '/assets/aboutOpenMetadata'

export const ABOUT_OPENMETADATA = [
    {
        image: `${IMAGE_ROUTE}/release-2.0.png`,
        header: 'Product News',
        description: 'Announcing OpenMetadata Release 2.0',
    ...
    },
    {
        ...
        href: '/case-study/carrefour-brazil',
        linkText: "Read",
        isExternal: false
    },
    {
        image: `${IMAGE_ROUTE}/vision-img.webp`,
        header: 'Vision',
    ...
    },
    {
        ...
        header: 'Video',
        description: 'June 2026 Community Meeting',
        href: 'https://www.youtube.com/watch?v=wFmgpDtf88k',
        linkText: "Watch",
        isExternal: true
    },
    {
        ...
        header: 'Case Study',
        description: 'Gorgias Drives AI-Powered Data Discovery and Governance',
        href: '/case-study/gorgias',
        linkText: "Read",
        isExternal: false
    },
