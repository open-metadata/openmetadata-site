export const INTEGRATION_SERVICES = [
  {
    ...
    services: [
      {
        href: 'https://docs.open-metadata.org/latest/connectors/api/rest',
  ...
  },
  {
    ...
    services: [
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/athena',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/bigquery',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/clickhouse',
        src: '/assets/services/clickhouse.webp',
        alt: 'service-clickhouse',
        name: 'ClickHouse',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/cockroach',
      ...
      {
        name: 'Couchbase',
        href: 'https://docs.open-metadata.org/latest/connectors/database/couchbase',
        alt: 'service-couchbase',
        src: '/assets/services/couchbase.webp',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/deltalake',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/druid',
        src: '/assets/services/druid.webp',
        alt: 'service-druid',
        name: 'Druid',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/databricks',
        src: '/assets/services/databrick.webp',
        alt: 'service-databrick',
        name: 'Databricks',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/domo-database',
        src: '/assets/services/service-icon-domo.webp',
        alt: 'service-domo',
        name: 'Domo',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/dynamodb',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/glue',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/greenplum',
        name: 'Greenplum',
        src: '/assets/services/greenplum.webp',
        alt: 'service-greenplum',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/hive',
        src: '/assets/services/hive.webp',
        alt: 'service-hive',
        name: 'Hive',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/db2',
        src: '/assets/services/ibmdb2.webp',
        alt: 'service-ibmdb2',
        name: 'IBM Db2',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/impala',
        src: '/assets/services/service-icon-impala.webp',
        alt: 'service-impala',
        name: 'Impala',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/mariadb',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/mysql',
      ...
      {
        name: 'MongoDB',
        href: 'https://docs.open-metadata.org/latest/connectors/database/mongodb',
        src: '/assets/services/mongodb.webp',
        alt: 'service-mongodb',
      },
      {
        name: 'SAP HANA',
        href: 'https://docs.open-metadata.org/latest/connectors/database/sap-hana',
        src: '/assets/services/sap-hana.png',
        alt: 'service-sap-hana',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/oracle',
        src: '/assets/services/oracle.webp',
        alt: 'service-oracle',
        name: 'Oracle',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/postgres',
        src: '/assets/services/postgres.webp',
        alt: 'service-postgres',
        name: 'PostgreSQL',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/presto',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/salesforce',
        src: '/assets/services/salesforce.webp',
        alt: 'service-salesforce',
        name: 'Salesforce',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/sas',
        src: '/assets/services/sas-viya.svg',
        alt: 'service-sas-viya',
        name: 'SAS Viya',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/snowflake',
        src: '/assets/services/snowflake.webp',
        alt: 'service-snowflake',
        name: 'Snowflake',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/singlestore',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/vertica',
        src: '/assets/services/vertica.webp',
        alt: 'service-vertica',
        name: 'Vertica',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/pinotdb ',
        src: '/assets/services/pinot.png',
        alt: 'service-pinot',
        name: 'Pinot DB',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/database/sqlite ',
  ...
  },
  {
    ...
    services: [
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/messaging/redpanda',
      ...
      },
      {
        ...
        name: 'Kinesis',
        href: 'https://docs.open-metadata.org/latest/connectors/messaging/kinesis',
      },
    ],
  },
  {
    ...
    services: [
      ...
      {
        name: 'Qlik Sense',
        href: 'https://docs.open-metadata.org/latest/connectors/dashboard/qliksense',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/dashboard/metabase',
        src: '/assets/services/metabase.webp',
        alt: 'service-metabase',
        name: 'Metabase',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/dashboard/mode',
        src: '/assets/services/mode.png',
        alt: 'service-mode',
        name: 'Mode',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/dashboard/powerbi',
        src: '/assets/services/powerbi.webp',
        alt: 'service-powerbi',
        name: 'Power BI',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/dashboard/redash',
        src: '/assets/services/redash.webp',
        alt: 'service-redash',
        name: 'Redash',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/dashboard/sigma',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/dashboard/tableau',
  ...
  },
  {
    ...
    services: [
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/pipeline/airbyte',
      ...
      {
        href: 'https://docs.open-metadata.org/latest/connectors/pipeline/fivetran',
      ...
      },
      {
        ...
        name: 'NiFi',
        href: 'https://docs.open-metadata.org/latest/connectors/pipeline/nifi',
      },
      {
        name: 'Spline',
        href: 'https://docs.open-metadata.org/latest/connectors/pipeline/spline',
        src: '/assets/services/spline.webp',
        alt: 'service-spline',
      },
      {
        name: 'Flink',
        href: 'https://docs.open-metadata.org/latest/connectors/pipeline/flink',
  ...
  },
  {
    ...
    services: [
      {
        href: 'https://docs.open-metadata.org/latest/connectors/ml-model/mlflow',
  ...
  },
  {
    ...
    services: [
      {
        href: 'https://docs.open-metadata.org/latest/connectors/metadata/amundsen',
        src: '/assets/services/amundsen.webp',
        alt: 'service-amundsen',
        name: 'Amundsen',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/metadata/atlas',
        src: '/assets/services/atlas.webp',
        alt: 'service-atlas',
        name: 'Atlas',
      },
      {
        href: 'https://docs.open-metadata.org/latest/connectors/metadata/alationsink',
  ...
  },
  {
    ...
    services: [
      {
        name: 'Elasticsearch',
        href: 'https://docs.open-metadata.org/latest/connectors/search/elasticsearch',
        src: '/assets/services/elasticsearch.webp',
        alt: 'service-elasticsearch',
      },
      {
        name: 'OpenSearch',
        href: 'https://docs.open-metadata.org/latest/connectors/search/opensearch',
    ...
    services: [
      {
        ...
        href: 'https://docs.open-metadata.org/latest/connectors/storage/gcs',
        src: '/assets/services/service-icon-gcs.webp',
        alt: 'service-gcs',
      },
      {
        name: 'AWS S3 Storage',
        href: 'https://docs.open-metadata.org/latest/connectors/storage/s3',
        src: '/assets/services/amazons3.webp',
        alt: 'service-s3',
      },
    ],
