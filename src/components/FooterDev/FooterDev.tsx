    ...
    <footer className="pt-24 pb-12 mt-auto w-full bg-[#333333] text-white">
      <div className="custom-container sm:grid sm:gap-5 sm:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 px-8 md:px-20 xl:px-28">
        ...
        <div>
          ...
          <ul className="text-[14px] tracking-[-0.02em] flex gap-2">
            <li className="mb-1">
              <Link
            ...
            <li className="mb-1">
              ...
              >
                <svg
                  className="svg-inline--fa fa-meetup fa-w-16 w-[12px]"
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    d="M24 24L14.6145 10.0124L14.6305 10.0255L23.0929 0H20.265L13.3713 8.16L7.89684 0H0.480213L9.24251 13.0593L9.24144 13.0582L0 24H2.82792L10.4921 14.9215L16.5834 24H24ZM6.77634 2.18182L19.9449 21.8182H17.7039L4.52468 2.18182H6.77634Z"
                    fill="currentColor"
                  />
                </svg>
              </Link>
