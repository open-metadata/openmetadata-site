...
const ResourceGallery = ({
  ...
  return (
    <div className="mt-12">
      <div className="text-[#292929] tracking-[-0.02em] text-2xl">
            ...
            <a href={item.href} target={item.isExternal ? "_blank" : "_self"}>
              <div className="grid grid-cols-5">
                ...
                <div className="py-3 px-4 col-span-3">
                  <div className="header-text text-[#474E71] text-sm sm:text-base font-medium mb-1">
                    {item.header}
                  </div>
                  <div className="text-[#2E3457] text-xs sm:text-sm">
                    {item.description}
                  </div>
                </div>
              </div>
