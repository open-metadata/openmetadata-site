      ...
      <div className="custom-container flex justify-center items-center gap-3">
        ...
        <div className="max-w-[80%] lg:flex lg:gap-3 lg:items-center">
          ...
          <span className="lg:relative">
            <Link
              className="border-none lg:leading-[31.2px] underline decoration-1 underline-offset-[2px] pl-2 text-[16px] lg:py-2 lg:px-4 lg:no-underline lg:border lg:border-[#D3ECF7] hover:text-[#D3ECF7]"
