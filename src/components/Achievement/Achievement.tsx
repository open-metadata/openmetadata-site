  ...
  return (
    <div>
      <div className="custom-container py-[32px] px-5 md:px-16 md:py-[72px]">
        <div className="flex rounded-lg flex-col w-full lg:flex-row">
          ...
          <div className="right-bottom-box bg-[#E0D5FF] bg-opacity-70 w-full px-4 pt-[48px] pb-[16px] sm:pt-[84px] sm:pb-[84px] sm:px-10 xl:px-[68px]">
